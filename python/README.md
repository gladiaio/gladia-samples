...
First, grab your API key at [docs.gladia.io](https://docs.gladia.io/chapters/introduction/getting-started), set it as `GLADIA_API_KEY` in your environment (or in the `.env` file) and you're good to go !
